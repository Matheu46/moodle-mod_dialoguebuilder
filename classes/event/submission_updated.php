...
/**
 * The mod_dialoguebuilder submission updated event class.
 *
...
class submission_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionupdated', 'mod_dialoguebuilder');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has updated the dialogue submission with id '$this->objectid' " .
