...
if (isset($dialoguebuilder->gallerymode) && $dialoguebuilder->gallerymode > 0) {
    if ($isteacher) {
        ...
        $hassubmitted = ($submission && $submission->status === 'submitted');
...
$backurl = new moodle_url('/mod/dialoguebuilder/view.php', ['id' => $cm->id]);
